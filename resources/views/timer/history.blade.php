            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="px-6 bg-white border-b border-gray-200">
                    <div class="mt-5 flex justify-center">
                        @if($total == 'all')
                        <span class="text-2xl text-white bg-red-700 py-1 px-10 md:px-15 rounded-lg">全て</span>
                        @elseif($total == 'month')
                        <span class="text-2xl text-white bg-red-700 py-1 px-10 md:px-15 rounded-lg">今月</span>
                        @elseif($total == 'day')
                        <span class="text-2xl text-white bg-red-700 py-1 px-10 md:px-15 rounded-lg">今日</span>
                        @endif
                    </div>

                    {{-- 15分用 --}}
                    <section class="text-gray-600 body-font">
                        <div class="container p-5 mx-auto border-b border-gray-200">
